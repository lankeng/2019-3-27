...
<div class="data-list clear">请选择商品分类：
    ...
    <table border="1">
        <form action="/sp_shop/Admin/Recycle/undelSelect/cid/<?php echo ($cid); ?>" method="post">
            <tr><th width="120">商品编号</th><th>商品名</th><th width="140">操作</th></tr>
            <?php if(is_array($goods["list"])): foreach($goods["list"] as $key=>$v): ?><tr><td><input type="checkbox" name="gid[]" value="<?php echo ($v["gid"]); ?>" /><?php echo ($v["gid"]); ?></td>
                    <td><?php echo ($v["gname"]); ?></td>
                    <td class="center"><a style="color:red;" href="/sp_shop/Admin/Recycle/undel/gid/<?php echo ($v["gid"]); ?>/cid/<?php echo ($cid); ?>">还原</a> <a style="color:red;" href="/sp_shop/Admin/Goods/revise/gid/<?php echo ($v["gid"]); ?>/cid/<?php echo ($cid); ?>" target="_blank" >修改</a> <a style="color:red;" href="/sp_shop/Admin/Recycle/del/gid/<?php echo ($v["gid"]); ?>/cid/<?php echo ($cid); ?>">删除</a></td>
...
<script>
    $("select").change(function () {
        window.location.href = "/sp_shop/Admin/Recycle/index/cid/" + $(this).val();
    });
    $(function () {
        $("tr:odd").addClass("odd");
    });
