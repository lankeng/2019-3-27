    ...
    <span class="label label-primary"  style="padding:8px;font-size:14px;">管理收货地址<span class="glyphicon glyphicon-map-marker" style="margin-left:10px"></span></span>
        <form method="post">
            ...
            <table class="table table-striped table-bordered  text-center" style="width:800px;margin:20px auto;">
                <tr><td>收件人：</td><td><input class="form-control" style="display:inline;width:305px;" type="text" name="consignee" /></td></tr>
                <tr><td>收件地区：</td><td>
                        <select id="province" onchange="toCity()" class="form-control" style="display:inline;width:100px;"></select>
                        <select id="city" onchange="toArea()" class="form-control" style="display:inline;width:100px;"></select>
                        <select id="area" class="form-control" style="display:inline;width:100px;"></select>
                    </td></tr>
                <tr><td>详细地址：</td><td><input class="form-control" style="display:inline;width:305px;" id="addr" type="text" /></td></tr>
                <tr><td>联系电话：</td><td><input class="form-control" style="display:inline;width:305px;" type="text" name="tel"/></td></tr>
                <tr><td>手机：</td><td><input class="form-control" style="display:inline;width:305px;" type="text" name="cellphone" /></td></tr>
                <tr><td>邮箱：</td><td><input class="form-control" style="display:inline;width:305px;" type="text" name="email" /></td></tr>
