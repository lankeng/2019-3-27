...
$("#<?php echo (CONTROLLER_NAME); ?>_<?php echo (ACTION_NAME); ?>").addClass("curr");
    ...
    <div class=" ">
		...
		<a href="/sp_shop/Home/User/addrNew" class="btn btn-default">添加新地址</a>
        <?php if(is_array($adds)): foreach($adds as $key=>$row): ?><div class="add">
                <div class="add-titel">
                	
                	<span class="add-line btn-group">
	                	<button class="btn btn-default">
							<a class="glyphicon glyphicon-edit" href="/sp_shop/Home/User/addrEdit/id/<?php echo ($row["id"]); ?>"></a>
						</button>
						<button class="btn btn-default">
							<a class="glyphicon glyphicon-trash" href="/sp_shop/Home/User/addrDele/id/<?php echo ($row["id"]); ?>" onclick="return confirm('确定要清空数据吗？')"></a>
						</button>
                	</span></div>
                <div class="add-margin"><span class="index">收件人：</span><div><?php echo ($row["consignee"]); ?></div></div>
                <div class="add-margin"><span class="index">详细地址：</span><div><?php echo ($row["address"]); ?></div></div>
                <div class="add-margin"><span class="index">手机：</span><div><?php echo ($row["cellphone"]); ?></div></div>
                <div class="add-margin"><span class="index">邮箱：</span><div><?php echo ($row["email"]); ?></div></div>
